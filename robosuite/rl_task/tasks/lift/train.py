...
if __name__ == "__main__":
    ...
    if not os.path.exists("rl_task/tasks/lift/model"):
        os.makedirs("rl_task/tasks/lift/model")
    ...
    agent = Agent(
        ...
        checkpoint_dir="rl_task/tasks/lift/model",
    )
    
    print("Training on device:", agent.device)

    writer = SummaryWriter("rl_task/tasks/lift/logs")
